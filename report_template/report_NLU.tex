...
I collaborated with Claude (Anthropic) while carrying out this project: it
helped set up and debug the remote GPU environment, launch and monitor the
training runs, generate the figures, and typeset this report. The choice of
hyper-parameters to search, the model architecture, and the interpretation of
the results are my own.
